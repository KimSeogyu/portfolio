...
type Posting struct {
	...
	// 게시물의 현재 상태
	Status PostingStatus `protobuf:"varint,11,opt,name=status,proto3,enum=board.v1.PostingStatus" json:"status,omitempty"`
	// 게시물의 댓글 목록
...
var file_board_v1_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc4, 0x03, 0x0a, 0x07, 0x50, 0x6f, 0x73, 0x74, 0x69, 0x6e, 0x67,
	...
	0x64, 0x41, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x76, 0x69, 0x65, 0x77, 0x5f, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x76, 0x69, 0x65, 0x77, 0x43, 0x6f, 0x75,
	...
	,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x6f, 0x73, 0x74, 0x69, 0x6e,
	0x67, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x6f, 0x73, 0x74,
	0x69, 0x6e, 0x67, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12,
	0x1b, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b,
	0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x05, 0x64, 0x65, 0x70, 0x74, 0x68, 0x12, 0x2f, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
...
var file_board_v1_service_proto_depIdxs = []int32{
	...
	0,  // 2: board.v1.Posting.status:type_name -> board.v1.PostingStatus
	5,  // 3: board.v1.Posting.comments:type_name -> board.v1.Comment
	18, // 4: board.v1.Comment.created_at:type_name -> google.protobuf.Timestamp
	18, // 5: board.v1.Comment.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 6: board.v1.Comment.status:type_name -> board.v1.CommentStatus
	5,  // 7: board.v1.Comment.children:type_name -> board.v1.Comment
	0,  // 8: board.v1.CreatePostingRequest.status:type_name -> board.v1.PostingStatus
	2,  // 9: board.v1.ListPostingsRequest.sort_by:type_name -> board.v1.SortBy
	3,  // 10: board.v1.ListPostingsRequest.sort_direction:type_name -> board.v1.SortDirection
	4,  // 11: board.v1.ListPostingsResponse.postings:type_name -> board.v1.Posting
	0,  // 12: board.v1.UpdatePostingRequest.status:type_name -> board.v1.PostingStatus
	18, // 13: board.v1.SearchPostingsRequest.created_after:type_name -> google.protobuf.Timestamp
	18, // 14: board.v1.SearchPostingsRequest.created_before:type_name -> google.protobuf.Timestamp
	3,  // 15: board.v1.SearchPostingsRequest.sort_direction:type_name -> board.v1.SortDirection
	3,  // 16: board.v1.ListCommentsByPostingRequest.sort_direction:type_name -> board.v1.SortDirection
	5,  // 17: board.v1.ListCommentsResponse.comments:type_name -> board.v1.Comment
	6,  // 18: board.v1.BoardService.CreatePosting:input_type -> board.v1.CreatePostingRequest
	7,  // 19: board.v1.BoardService.GetPosting:input_type -> board.v1.GetPostingRequest
	8,  // 20: board.v1.BoardService.ListPostings:input_type -> board.v1.ListPostingsRequest
	14, // 21: board.v1.BoardService.ListCommentsByPosting:input_type -> board.v1.ListCommentsByPostingRequest
	13, // 22: board.v1.BoardService.CreateComment:input_type -> board.v1.CreateCommentRequest
	16, // 23: board.v1.BoardService.UpdateComment:input_type -> board.v1.UpdateCommentRequest
	17, // 24: board.v1.BoardService.DeleteComment:input_type -> board.v1.DeleteCommentRequest
	10, // 25: board.v1.BoardService.UpdatePosting:input_type -> board.v1.UpdatePostingRequest
	11, // 26: board.v1.BoardService.DeletePosting:input_type -> board.v1.DeletePostingRequest
	12, // 27: board.v1.BoardService.SearchPostings:input_type -> board.v1.SearchPostingsRequest
	4,  // 28: board.v1.BoardService.CreatePosting:output_type -> board.v1.Posting
	4,  // 29: board.v1.BoardService.GetPosting:output_type -> board.v1.Posting
	9,  // 30: board.v1.BoardService.ListPostings:output_type -> board.v1.ListPostingsResponse
	15, // 31: board.v1.BoardService.ListCommentsByPosting:output_type -> board.v1.ListCommentsResponse
	5,  // 32: board.v1.BoardService.CreateComment:output_type -> board.v1.Comment
	5,  // 33: board.v1.BoardService.UpdateComment:output_type -> board.v1.Comment
	19, // 34: board.v1.BoardService.DeleteComment:output_type -> google.protobuf.Empty
	4,  // 35: board.v1.BoardService.UpdatePosting:output_type -> board.v1.Posting
	19, // 36: board.v1.BoardService.DeletePosting:output_type -> google.protobuf.Empty
	9,  // 37: board.v1.BoardService.SearchPostings:output_type -> board.v1.ListPostingsResponse
